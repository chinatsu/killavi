...
a = killavi.Base('wiallee.avi') # load a file named sample.avi
# meta = [] # a list to store metadata (frame order, basically)
# framelength = len(a.frames)
# for idx in range(0, framelength): # iterate over every frame
#     if idx+35 > framelength:
